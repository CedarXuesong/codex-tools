export const PROJECT_REPOSITORY_URL = "https://github.com/Barbital11111/codex-tools";
export const PROJECT_REPOSITORY_DISPLAY = "github.com/Barbital11111/codex-tools";
